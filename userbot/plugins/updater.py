...
OFFICIAL_UPSTREAM_REPO = "https://github.com/HellBoy-OP/HellBot"
...
CmdHelp("updater").add_command(
  'update', None, 'Checks if the bot is up-to-date or not. Also, Updates your bot to new codes if any else Force updates bot.'
).add()
